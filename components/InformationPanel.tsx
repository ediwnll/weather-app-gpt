    ...
    <div className="bg-gradient-to-br from-[#655560] to-[#444242] p-10 text-white">
      ...
      <div className="flex items-center justify-between">
        <div>
          {/* Image */}
          <Image
            src={`https://weatherbit.io/static/img/icons/${weatherCodeToString[results.current_weather.weathercode].icon}.png`}
      ...
      <div className="space-y-2 py-5">
        <div className="flex items-center space-x-2 px-4 py-3 border rounded-sm bg-[#5c5459]">
          ...
          <div className="flex justify-between items-center flex-1">
            <p>Sunrise</p>
            <p className="text-2xl">{new Date(results.daily.sunrise[0]).toLocaleTimeString("en-GB",{
              hour:"numeric",
              minute:"numeric"
            })}</p>
          </div>
        ...
        <div className="flex items-center space-x-2 px-4 py-3 border rounded-sm bg-[#5c5459]">
          ...
          <div className="flex justify-between items-center flex-1">
            <p>Sunset</p>
            <p className="text-2xl">{new Date(results.daily.sunset[0]).toLocaleTimeString("en-GB",{
              hour:"numeric",
              minute:"numeric"
            })}</p>
          </div>
